...
import { pgTable, serial, varchar, text, timestamp, decimal, integer, jsonb, boolean } from "drizzle-orm/pg-core";
...
export const returnPolicies = pgTable("return_policies", {
  ...
  // Fees
  restockingFeePercentage: decimal("restocking_fee_percentage", { precision: 5, scale: 2 }).default("0.00"),
...
export const DEFAULT_RETURN_REASONS = [
  ...
  { code: 'DEFECTIVE', nameEn: 'Defective Product', nameAr: 'منتج معيب', refundPercentage: 100, requiresPhotos: true },
  { code: 'NOT_AS_DESCRIBED', nameEn: 'Not as Described', nameAr: 'غير مطابق للوصف', refundPercentage: 100, requiresPhotos: true },
  { code: 'DAMAGED_IN_SHIPPING', nameEn: 'Damaged in Shipping', nameAr: 'تالف أثناء الشحن', refundPercentage: 100, requiresPhotos: true },
  ...
  { code: 'FOUND_BETTER_PRICE', nameEn: 'Found Better Price', nameAr: 'وجدت سعر أفضل', refundPercentage: 85 },
  { code: 'LATE_DELIVERY', nameEn: 'Late Delivery', nameAr: 'تأخر التوصيل', refundPercentage: 100 },
  { code: 'OTHER', nameEn: 'Other', nameAr: 'سبب آخر', refundPercentage: 85, requiresDescription: true },
];
