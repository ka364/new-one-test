...
// ============================================
export const spreadsheetSessions = pgTable(
...
// ============================================
export const spreadsheetSharing = pgTable(
  'spreadsheet_sharing',
  {
    id: varchar('id', { length: 36 }).primaryKey(),
    sessionId: varchar('session_id', { length: 36 }).notNull(),
...
// ============================================
export const spreadsheetEdits = pgTable(
  'spreadsheet_edits',
  {
    id: varchar('id', { length: 36 }).primaryKey(),
    sessionId: varchar('session_id', { length: 36 }).notNull(),
...
// ============================================
export const spreadsheetFormulas = pgTable(
...
// ============================================
export const spreadsheetCharts = pgTable(
  'spreadsheet_charts',
  {
    id: varchar('id', { length: 36 }).primaryKey(),
    sessionId: varchar('session_id', { length: 36 }).notNull(),
