...
This directory contains the implementation of the 7 bio-protocol modules that
form the core of HaderOS.
...
6.  **Chameleon (Adaptive Strategy):** Adapts pricing and strategy to market
    conditions.
7.  **Cephalopod (Distributed Authority):** Manages distributed decision-making.

## Orchestrator

The `orchestrator.ts` file contains the `BioProtocolOrchestrator` which
integrates all 7 modules and provides a unified interface for the system.

## Testing

The `bio-modules.test.ts` file contains a comprehensive test suite for all
modules.
