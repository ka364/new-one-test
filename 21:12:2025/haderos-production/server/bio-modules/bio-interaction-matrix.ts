...
export const BIO_INTERACTION_MATRIX: BioInteraction[] = [
  ...
  // ========================================
  {
    ...
    priority: 10,
    description: "When Arachnid detects critical anomaly, trigger Tardigrade to enter protective mode",
...
export function getModuleInteractions(moduleName: BioModuleName): BioInteraction[] {
  ...
  return BIO_INTERACTION_MATRIX.filter(
    i => i.from === moduleName || i.to === moduleName
  );
}
