...
export const appRouter = router({
  ...
  chat: router({
    sendMessage: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const history = await getChatMessagesByConversation(conversationId, 20);

        // Build messages for LLM
        const messages = [
          {
            role: "system" as const,
            content: "You are HaderOS AI Assistant, an intelligent business management assistant with expertise in ethical business practices, financial analysis, and operational optimization. You help users understand their data, make informed decisions, and ensure all operations comply with Sharia principles. Always provide clear, actionable insights in both English and Arabic when appropriate."
          },
          ...history.map(msg => ({
    ...
    getHistory: protectedProcedure
      ...
      .query(async ({ input }) => {
        return await getChatMessagesByConversation(input.conversationId, 100);
      }),
  ...
  // ============================================
  // ADAPTIVE LEARNING & GOOGLE DRIVE
  // ============================================
  adaptive: adaptiveRouter,
  contentCreator: contentCreatorRouter,

  // ============================================
  // NOW SHOES E-COMMERCE
  // ============================================
