...
import { pgTable, text, timestamp, integer, boolean, decimal, jsonb, uuid, pgEnum, date, time } from "drizzle-orm/pg-core";
...
export const darkStoreInventory = pgTable("dark_store_inventory", {
  ...
  darkStoreId: uuid("dark_store_id").references(() => darkStores.id).notNull(),
...
export const holidayPromotions = pgTable("holiday_promotions", {
  ...
  holidayId: uuid("holiday_id").references(() => egyptianHolidays.id).notNull(),
...
export const DEFAULT_EGYPTIAN_CATEGORIES = [
  ...
  { code: "VEGETABLES_LEAFY", nameAr: "خضروات ورقية", nameDarija: "ورقيات", parentCode: "VEGETABLES" },
  { code: "VEGETABLES_ROOT", nameAr: "خضروات جذرية", nameDarija: "جزر وبنجر", parentCode: "VEGETABLES" },
  { code: "VEGETABLES_POTATO", nameAr: "بطاطس وبصل", nameDarija: "بطاطس وبصل", parentCode: "VEGETABLES" },
  ...
  { code: "FRUITS_TROPICAL", nameAr: "فواكه استوائية", nameDarija: "مانجا وموز", parentCode: "FRUITS" },
  ...
  { code: "BEVERAGES_SODA", nameAr: "مشروبات غازية", nameDarija: "حاجة ساقعة", parentCode: "BEVERAGES" },

  // التنظيف
  { code: "CLEANING", nameAr: "منتجات التنظيف", nameDarija: "منظفات", icon: "🧹" },
  { code: "CLEANING_LAUNDRY", nameAr: "غسيل الملابس", nameDarija: "مسحوق غسيل", parentCode: "CLEANING" },
  { code: "CLEANING_DISHES", nameAr: "غسيل الأطباق", nameDarija: "صابون مواعين", parentCode: "CLEANING" },
];
...
export const DEFAULT_EGYPTIAN_SYNONYMS = [
  // الخبز
  { standardTerm: "bread", standardTermAr: "خبز", egyptianVariants: ["عيش", "عيش بلدي", "عيش فينو", "عيش شامي"] },
  ...
  // الزبادي
  { standardTerm: "yogurt", standardTermAr: "لبن رائب", egyptianVariants: ["زبادي", "زبادى", "ياغورت"] },
];
