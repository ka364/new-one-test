...
// Lazy load schemas
let techVendors: any, subscriptions: any, expenses: any, vendorInvoices: any;
let payments: any, expenseAlerts: any, expenseBudgets: any, expenseReports: any;
let scalingHierarchy: any;

try {
  const schema = require('../../drizzle/schema-expenses-integrated');
  techVendors = schema.techVendors;
  subscriptions = schema.subscriptions;
  expenses = schema.expenses;
  vendorInvoices = schema.vendorInvoices;
  payments = schema.payments;
  expenseAlerts = schema.expenseAlerts;
  expenseBudgets = schema.expenseBudgets;
  expenseReports = schema.expenseReports;

  const scaling = require('../../drizzle/schema-7x7-scaling');
  scalingHierarchy = scaling.scalingHierarchy;
} catch {
