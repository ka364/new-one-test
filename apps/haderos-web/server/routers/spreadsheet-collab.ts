...
import {
  ...
  spreadsheetFormulas,
  spreadsheetCharts,
  insertCellCommentSchema,
  insertSpreadsheetVersionSchema,
  insertSpreadsheetSharingSchema,
  insertSpreadsheetFormulaSchema,
  insertSpreadsheetChartSchema,
...
export const spreadsheetCollabRouter = createTRPCRouter({
  ...
  addComment: protectedProcedure
    .input(
      insertCellCommentSchema.extend({
        sessionId: z.string(),
        hierarchyPath: z.string(),
  ...
  deleteComment: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await db.delete(cellComments).where(eq(cellComments.id, input.commentId));
  ...
  createVersion: protectedProcedure
    .input(
      insertSpreadsheetVersionSchema.extend({
        sessionId: z.string(),
        hierarchyPath: z.string(),
  ...
  share: protectedProcedure
    .input(
      insertSpreadsheetSharingSchema.extend({
        sessionId: z.string(),
  ...
  addFormula: protectedProcedure
    .input(
      insertSpreadsheetFormulaSchema.extend({
        sessionId: z.string(),
        cellAddress: z.string(),
        rowIndex: z.number(),
        columnKey: z.string(),
  ...
  deleteFormula: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      await db.delete(spreadsheetFormulas).where(eq(spreadsheetFormulas.id, input.formulaId));
  ...
  createChart: protectedProcedure
    .input(
      insertSpreadsheetChartSchema.extend({
        sessionId: z.string(),
