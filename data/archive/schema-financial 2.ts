...
export const employees = mysqlTable("employees", {
  ...
  // Employment Details
  department: mysqlEnum("department", ["sales", "home_based", "factory", "management", "logistics"]).notNull(),
  ...
  // Status
  status: mysqlEnum("status", ["active", "on_leave", "suspended", "terminated"]).default("active"),
...
export const attendance = mysqlTable("attendance", {
  ...
  status: mysqlEnum("status", ["present", "absent", "late", "half_day", "leave", "holiday"]).notNull(),
...
export const advertisingExpenses = mysqlTable("advertising_expenses", {
  id: int("id").primaryKey().autoincrement(),
  
  // Campaign Details
  platform: mysqlEnum("platform", ["facebook", "instagram", "google", "tiktok", "snapchat", "other"]).notNull(),
...
export const subscriptions = mysqlTable("subscriptions", {
  ...
  billingCycle: mysqlEnum("billing_cycle", ["monthly", "quarterly", "annually", "per_transaction"]).notNull(),
...
export const factorySupplyOrders = mysqlTable("factory_supply_orders", {
  id: int("id").primaryKey().autoincrement(),
...
export const financialSummary = mysqlTable("financial_summary", {
  ...
  periodType: mysqlEnum("period_type", ["daily", "weekly", "monthly", "quarterly", "yearly"]).default("monthly"),
  ...
  advertisingExpenses: decimal("advertising_expenses", { precision: 12, scale: 2 }).default("0.00"),
  subscriptionExpenses: decimal("subscription_expenses", { precision: 10, scale: 2 }).default("0.00"),
  shippingExpenses: decimal("shipping_expenses", { precision: 10, scale: 2 }).default("0.00"),
  operationalExpenses: decimal("operational_expenses", { precision: 10, scale: 2 }).default("0.00"),
